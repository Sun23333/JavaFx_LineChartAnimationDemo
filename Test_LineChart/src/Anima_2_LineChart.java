...
public class Anima_2_LineChart extends Application {
	...
	private void plotTime() {
		if (i >= 5 * 5000) {
			if (i % 2500 == 0) {
				xAxis.setLowerBound(xAxis.getLowerBound() + 2500);
				xAxis.setUpperBound(xAxis.getUpperBound() + 2500);
			}
		}
